...
public class BullsAndCows {
	...
	public void play() {
		...
		while (true) {
			...
			String str = String.format("%d cows, %d bulls", bullsCowsMap.get(BullsCowsEnum.COWS),
					bullsCowsMap.get(BullsCowsEnum.BULLS));
	...
	private void updateHistoryMap(int[] inputNumbers, HashMap<BullsCowsEnum, Integer> bullsCowsMap) {
		...
		str += String.format("(%d cows, %d bulls)", bullsCowsMap.get(BullsCowsEnum.COWS),
				bullsCowsMap.get(BullsCowsEnum.BULLS));
